...
proc format library=stat1.myfmts fmtlib;
run;
...
ods graphics;
libname stat1 '~/ECST142/data';
options fmtsearch=(stat1.myfmts); /*Had to add in lines 21 and 22 so that the formats will work*/
...
ods select histogram; /*Use to supress tables and / or 'no print*/
